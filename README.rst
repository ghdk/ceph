...
:unit test:  `<https://docs.ceph.com/en/latest/dev/developer_guide/tests-unit-tests/>`_
...
:intro:
    docker run -it --stop-signal SIGQUIT --privileged --cap-add=SYS_PTRACE --security-opt seccomp=unconfined  --name ceph -v ~/Documents/gitspace:/mnt/macos --net=host  debian
    ./install-deps.sh
